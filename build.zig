...
pub fn build(b: *std.Build) void {
    ...
    cargo_build.setCwd(b.path("roundtrip_tester"));

    const lib_mod = b.addModule("borsh", .{
    ...
    const object_file_path = switch (optimize) {
        .Debug => "roundtrip_tester/target/debug/libroundtrip_tester.a",
        else => "roundtrip_tester/target/release/libroundtrip_tester.a",
    };
